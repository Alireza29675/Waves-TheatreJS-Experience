...
import { particlesProps, cameraProps } from './theatre/theatre-props';
...
class Animation {
    ...
    constructor(container) {
        this.knot = new Knot(container, 640, 350);
    ...
    initializeTheatre() {
        this.theatre = {};
        this.theatre.project = new Theatre.Project('Max Cooper - Waves', { state: animationState });
...
const animation = new Animation(document.querySelector('#app'));